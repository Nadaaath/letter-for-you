      ...
      <div className="mb-8 grid gap-6 lg:grid-cols-[1fr_auto] lg:items-start">
        ...
        <div className="glass-card rounded-[2rem] p-6 shadow-soft lg:w-80">
          ...
          <p className="mt-2 text-sm leading-6 text-rose-950/70">
            Generate one access code for this whole private garden. The recipient
            will see all letters inside it.
          </p>
      ...
      <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          ...
          <p className="mt-1 text-rose-950/70">
            Add one or many letters. They will all be opened using the same
            garden code.
          </p>
        </div>
...
function GardenLetterCard({ letter, onDelete }) {
  ...
  return (
    <article className="group overflow-hidden rounded-[2rem] border border-rose-100 bg-white/75 p-6 shadow-soft transition hover:-translate-y-1 hover:bg-white">
      ...
      <div
        className="mb-5 rounded-2xl border border-rose-100 p-4"
        style={{
          backgroundColor,
          color: textColor,
        }}
      ...
      <div className="flex flex-wrap gap-2 text-xs text-rose-950/65">
